...
const OrderLis = ({orders}: OrderListProps) => {
    return (  
        <div className="space-y-6 p-6">
            ...
            {orders.map((order) => (
                <Card key={order.id}>
                    ...
                    <div className={`w-fit rounded-full px-2 py-1 text-semibold text-white ${order.status === OrderStatus.FINISHED ? "bg-green-500 text-white" : "bg-gray-200 text-gray-500" }`}>
